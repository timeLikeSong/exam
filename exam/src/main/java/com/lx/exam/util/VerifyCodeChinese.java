...
public class VerifyCodeChinese {

	public VerifyCodeChinese() {
	 ...
	 * @return
	 * @author 徐明
	 * @data 2015年9月7日 上午10:33:40
	 */
	private static String drawRandomNum(Graphics2D g, int count) {
